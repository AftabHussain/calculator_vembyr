...
Result rule_start(Stream & stream, const int position){
    ...
    Result result_peg_3(myposition);
        ...
        
        {
            ...
            result_peg_3 = rule_expression(stream, result_peg_3.getPosition());
...
Result rule_expression(Stream & stream, const int position){
    ...
    Column & column_peg_2 = stream.getColumn(position);
    if (column_peg_2.chunk0 != 0 && column_peg_2.chunk0->chunk_expression.calculated()){
        return column_peg_2.chunk0->chunk_expression;
    }
    
    
    RuleTrace trace_peg_1(stream, "expression");
    int myposition = position;
    ...
    Result result_peg_3(myposition);
        ...
        
        {
            ...
            result_peg_3 = rule_expression2(stream, result_peg_3.getPosition());
                if (result_peg_3.error()){
                    goto out_peg_5;
                }
            ...
            result_peg_3 = rule_expression1_rest(stream, result_peg_3.getPosition(), result_peg_4.getValues());
                if (result_peg_3.error()){
                    goto out_peg_5;
                }
        ...
        column_peg_2.chunk0->chunk_expression = result_peg_3;
        stream.update(result_peg_3.getPosition());
        ...
        column_peg_2.chunk0->chunk_expression = errorResult;
        stream.update(errorResult.getPosition());
...
Result rule_expression1_rest(Stream & stream, const int position, Value a){
    ...
    RuleTrace trace_peg_1(stream, "expression1_rest");
    int myposition = position;
    ...
    Result result_peg_3(myposition);
        {
            ...
            Result result_peg_7 = result_peg_3;
            
            {
                    Value value((void*) 0);
                    value = add(a,result_peg_7.getValues());
                    result_peg_3.setValue(value);
                }
                e = result_peg_3.getValues();
        ...
        Result result_peg_9(myposition);
        {
            ...
            result_peg_9 = rule_expression2(stream, result_peg_9.getPosition());
            ...
            {
                    Value value((void*) 0);
                    value =sub(a,result_peg_12.getValues());
...
Result rule_expression2(Stream & stream, const int position){
    ...
    Column & column_peg_2 = stream.getColumn(position);
    if (column_peg_2.chunk0 != 0 && column_peg_2.chunk0->chunk_expression2.calculated()){
        return column_peg_2.chunk0->chunk_expression2;
    }
    
    
    RuleTrace trace_peg_1(stream, "expression2");
    int myposition = position;
    ...
    Result result_peg_3(myposition);
        ...
        
        {
            ...
            result_peg_3 = rule_expression3(stream, result_peg_3.getPosition());
                if (result_peg_3.error()){
                    goto out_peg_5;
                }
            ...
            result_peg_3 = rule_expression2_rest(stream, result_peg_3.getPosition(), result_peg_4.getValues());
                if (result_peg_3.error()){
                    goto out_peg_5;
                }
        ...
        column_peg_2.chunk0->chunk_expression2 = result_peg_3;
        stream.update(result_peg_3.getPosition());
        ...
        column_peg_2.chunk0->chunk_expression2 = errorResult;
        stream.update(errorResult.getPosition());
...
Result rule_expression2_rest(Stream & stream, const int position, Value a){
    ...
    RuleTrace trace_peg_1(stream, "expression2_rest");
    int myposition = position;
    ...
    Result result_peg_3(myposition);
        {
            ...
            {
                    Value value((void*) 0);
                    value = multiply(a,result_peg_7.getValues());
                    result_peg_3.setValue(value);
                }
                e = result_peg_3.getValues();
        ...
        Result result_peg_9(myposition);
        {
            ...
            result_peg_9 = rule_expression3(stream, result_peg_9.getPosition());
                if (result_peg_9.error()){
                    goto out_peg_11;
                }
            ...
            {
                    Value value((void*) 0);
                    value = divide(a,result_peg_12.getValues());
                    result_peg_9.setValue(value);
                }
                e = result_peg_9.getValues();
...
Result rule_expression3(Stream & stream, const int position){
    ...
    Column & column_peg_2 = stream.getColumn(position);
    if (column_peg_2.chunk1 != 0 && column_peg_2.chunk1->chunk_expression3.calculated()){
        return column_peg_2.chunk1->chunk_expression3;
    }
    
    
    RuleTrace trace_peg_1(stream, "expression3");
    int myposition = position;
    ...
    Result result_peg_3(myposition);
        ...
        
        {
            int position_peg_5 = result_peg_3.getPosition();
            {
                ...
                
                {
                        Value value((void*) 0);
                        int total = 0;
                        for (Value::iterator it = result_peg_6.getValues().getValues().begin(); it !=
                        result_peg_6.getValues().getValues().end(); it++){
                        const Value & v = *it;
        ...
        column_peg_2.chunk1->chunk_expression3 = result_peg_3;
        stream.update(result_peg_3.getPosition());
        ...
        
        {
            ...
            result_peg_15 = rule_expression(stream, result_peg_15.getPosition());
        ...
        column_peg_2.chunk1->chunk_expression3 = result_peg_15;
        ...
        column_peg_2.chunk1->chunk_expression3 = errorResult;
        stream.update(errorResult.getPosition());
